...
console.log('🔧 FIXING .HTACCESS FOR _NUXT ASSETS');
console.log('====================================\n');

console.log('📋 FIXED .HTACCESS COMMANDS:');
console.log('=============================');
console.log('');
...
console.log('✅ Added file existence check for _nuxt assets');
console.log('✅ Added file existence check for static files');
console.log('✅ Proper document root path resolution');
console.log('✅ Better error handling');
console.log('');
console.log('🔧 Why this works:');
console.log('• Checks if the file actually exists before rewriting');
console.log('• Uses %{DOCUMENT_ROOT} for proper path resolution');
console.log('• Prevents 500 errors from non-existent files');
