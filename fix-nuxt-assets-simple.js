...
console.log('🔧 FIXING NUXT.JS STATIC ASSETS LOADING');
console.log('========================================\n');

console.log('📋 DEPLOYMENT COMMANDS TO FIX _NUXT ASSETS:');
console.log('============================================');
console.log('');
...
console.log('curl -k -I https://travelin-agency-nlcs.vercel.app/_nuxt/CNW6Qy33.js');
console.log('');
console.log('# 3. Test the admin page');
console.log('curl -k -I https://travelin-agency-nlcs.vercel.app/admin/login');
console.log('');
console.log('🎯 This will fix:');
console.log('✅ _nuxt CSS files loading (404 errors)');
console.log('✅ _nuxt JS files loading (404 errors)');
console.log('✅ Admin page styling and functionality');
console.log('✅ All Nuxt.js static assets');
