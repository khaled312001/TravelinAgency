import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, computed, unref, ref, h, Suspense, nextTick, mergeProps, provide, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { i as createHooks, k as getContext, f as createError$1, l as toRouteMatcher, m as createRouter, n as defu, o as hasProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, r as executeAsync } from '../_/nitro.mjs';
...
const namedMiddleware = {
  admin: () => import('./admin.mjs'),
  locale: () => import('./locale.mjs'),
  maintenance: () => import('./maintenance.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "error-page" }, _attrs))} data-v-89447d55><div class="error-container" data-v-89447d55><h1 data-v-89447d55>${ssrInterpolate(__props.error.statusCode)}</h1><h2 data-v-89447d55>${ssrInterpolate(__props.error.statusMessage)}</h2>`);
      if (__props.error.statusCode === 500) {
        _push(`<p data-v-89447d55> Server error occurred. Please try again later. </p>`);
      } else {
        _push(`<p data-v-89447d55>${ssrInterpolate(__props.error.message || "An error occurred")}</p>`);
      }
      _push(`<button class="retry-button" data-v-89447d55> Try Again </button></div></div>`);
    };
  }
};
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-89447d55"]]);
...
export { _export_sfc as _, defineNuxtRouteMiddleware as d, server as s };
