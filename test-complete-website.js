...
console.log('curl -k https://travelin-agency-nlcs.vercel.app/api/packages | head -c 500');
console.log('');
...
console.log('curl -k -I https://travelin-agency-nlcs.vercel.app/_ipx/q_80/images/home/logo/WonderlandLogo.svg');
console.log('');
console.log('# 6. Test static assets');
console.log('curl -k -I https://travelin-agency-nlcs.vercel.app/_nuxt/entry.css');
console.log('curl -k -I https://travelin-agency-nlcs.vercel.app/_nuxt/entry.js');
console.log('');
