...
console.log('curl -k https://worldtripagency.com/api/content');
console.log('curl -k https://worldtripagency.com/api/bookings');
console.log('curl -k https://worldtripagency.com/api/admin/users');
